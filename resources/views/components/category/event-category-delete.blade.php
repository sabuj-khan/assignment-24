        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div>
                    ...
                    <button onclick="DeleteEventCategory()" type="button" id="confirmDelete" class="btn shadow-sm btn-danger" >Delete</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    async function DeleteEventCategory(){
        ...
        showLoader();
        let response = await axios.post('/event-category-delete', {id:id});
        hideLoader();
